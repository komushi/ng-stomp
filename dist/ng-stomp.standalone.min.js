...
// Browser globals
a(angular,SockJS,Stomp)}(function(a,b,c){a.module("ngStomp",[]).service("$stomp",["$rootScope","$q",function(a,d){this.sock=null,this.stomp=null,this.debug=null,this.setDebug=function(a){this.debug=a},this.connect=function(a,e){e=e||{};var f=d.defer();return this.sock=new b(a),this.stomp=c.over(this.sock),this.stomp.debug=this.debug,this.stomp.connect(e,function(a){f.resolve(a)},function(a){f.reject(a)}),f.promise},this.disconnect=function(){var a=d.defer();return this.stomp.disconnect(a.resolve),a.promise},this.subscribe=this.on=function(a,b,c){return c=c||{},this.stomp.subscribe(a,function(a){var c=null;try{c=JSON.parse(a.body)}finally{b&&b(c,a.headers,a)}},c)},this.unsubscribe=this.off=function(a){a.unsubscribe()},this.send=function(a,b,c){var e=d.defer();try{var f=JSON.stringify(b);c=c||{},this.stomp.send(a,c,f),e.resolve()}catch(g){e.reject(g)}return e.promise}}])});