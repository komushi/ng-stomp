...
//   this.debug = callback
// }
this.connect=function(a,f,g){g=g||{};var h=d.defer();if("ws:"===e(f).protocol||"wss:"===e(f).protocol){var i=new WebSocket(f);this.stomps[a]=c.over(i),this.stomps[a].subs={}}else{var j=new b(f);this.stomps[a]=c.over(j),this.stomps[a].subs={}}
